                ...
                datasets: [
                    {
                        ...
                        backgroundColor: 'rgba(0, 123, 255, 0.6)', // Blue color with 60% opacity
    ...
    const chartOptions = {
        ...
        scales: {
            y: {
                ...
                title: {
                    display: true,
                    text: 'Number of Items', // Y-axis title
                    font: {
                        size: 20, // Increase font size for Y-axis label
                    },
                },
                ticks: {
            ...
            x: {
                title: {
                    display: true,
                    text: 'Price Ranges($)', // X-axis title
                    font: {
                        size: 20, // Increase font size for X-axis label
                    },
                },
            },
        },
